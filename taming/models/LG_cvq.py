...
from taming.modules.vqvae.quantize import CVQVectorQuantiser as VectorQuantizer
...
class VQModel(pl.LightningModule):
    def __init__(self,
        ...
        self.dim = embed_dim
        self.text_dim = 512
        self.text_mask_ratio = ddconfig['text_mask_ratio']
    ...
    def wrsrelation_sup(self, vision_token, quant, all_text_features, mask_padding):
        ...
        q = torch.matmul(all_text_features, all_text_features.permute(0, 2, 1))

        text_to_quant = text_to_quant * value.unsqueeze(-1)
    ...
    def training_step(self, batch, batch_idx, optimizer_idx):
        ...
        if optimizer_idx == 1:
            ...
            discloss, log_dict_disc = self.loss(qloss, x, xrec, optimizer_idx, self.global_step,
                                                nceloss=nceloss,
                                                mskloss=mskPre_loss, wrsloss=wrs_loss,
                                                last_layer=self.get_last_layer(), split="train")
