...
class Net2NetTransformer(pl.LightningModule):
    ...
    def log_images(self, batch, temperature=None, top_k=None, callback=None, lr_interface=False, **kwargs):
        ...
        N = 4
        if lr_interface:
            x, c = self.get_xc(batch, N=None, diffuse=False, upsample_factor=8)
        else:
            x, c = self.get_xc(batch, N=None)
    ...
    @torch.no_grad()
    def log_images_sample(self, batch, temperature=None, top_k=None, callback=None, lr_interface=False, **kwargs):
        log = dict()
