...
class VQLPIPS(nn.Module):
    def __init__(self, codebook_weight: float = 1.0,
                 ...
                 nceloss_weight=0.1, mskloss_weight=0.1, wrsloss_weight=0.1,
                 ) -> None:
        super().__init__()
    ...
    def forward(self, codebook_loss: torch.FloatTensor, inputs: torch.FloatTensor, reconstructions: torch.FloatTensor,
                ...
                split: Optional[str] = "train", nceloss=None, mskloss=None, wrsloss=None, isValid=False) -> Tuple:
        ...
        if isValid == False:
            # print("nceloss, mskloss, wrsloss",nceloss.item(), mskloss.item(), wrsloss.item())
...
class VQLPIPSWithDiscriminator(nn.Module):
    def __init__(self, disc_start, codebook_weight=1.0, pixelloss_weight=1.0,
                 ...
                 perceptual_weight=1.0, nceloss_weight=0.1, mskloss_weight=0.1,wrsloss_weight=0.1,
    ...
    def forward(self, codebook_loss, inputs, reconstructions, optimizer_idx,
                global_step, nceloss=None, mskloss=None, wrsloss=None, isValid=False,
        ...
        if optimizer_idx == 0:
            ...
            if isValid == False:
                ...
                log = {"{}/total_loss".format(split): loss.clone().detach().mean(),
                    ...
                    "{}/nce_loss".format(split): nceloss.detach(),
                    "{}/msk_loss".format(split): mskloss.detach(),
                    }
            else:
                log = {"{}/total_loss".format(split): loss.clone().detach().mean(),
                    "{}/quant_loss".format(split): codebook_loss.detach().mean(),
